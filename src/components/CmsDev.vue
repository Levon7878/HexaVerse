...
<template>
  <div class="card-container">
    <div class="text-block-cms">
      <h1>{{ $t('cmsDev.subtitle') }}</h1>
      <h2>{{ $t('cmsDev.title') }}</h2>
    </div>
    <div class="card-box">
      <div class="card" v-for="item in items1" :key="item">
    ...
    <div class="saas-container">
      <div class="text-block-saas">
        <h2>{{ $t('cmsDev.saasCms') }}</h2>
      </div>
      <div class="card-box">
        <div class="card" v-for="item in items2" :key="item">
          <div class="card-inner">
            <div class="card-front">
              <img :src="item.image" alt="" />
              <h3>{{ item.text }}</h3>
...
:global(.light .card-container){
  background: linear-gradient(to bottom, #abceeb, #d2ecff);
}

:global(.light .text-block-cms),
:global(.light .text-block-cms h1){
  color: #0d3b66;
}
</style>
