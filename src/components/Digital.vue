      ...
      <div class="card-grid2">
        <div class="card2" v-for="item in digitalItems" :key="item.id">
          ...
          <div class="card__content2">
            <p class="card__category2">{{ $t(item.title) }}</p>
            <div>
...
export default {
  ...
  setup() {
    ...
    return {
      digitalItems: store.digitalBlock
...
:global(.dark .hero-section2){
  background: linear-gradient(to bottom, #0d3b66, #051622);
}

:global(.light .hero-section2){
  background-color: aliceblue;
}

:global(.light .hero-section2 .block-text),
:global(.light .hero-section2 .block-text h2),
:global(.light .hero-section2 .block-text h3),
:global(.light .hero-section2 .block-text p){
  color: #0d3b66;
}
</style>