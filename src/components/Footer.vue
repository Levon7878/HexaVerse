        ...
        <div class="footer-container">
          ...
          <div class="about-us">
            ...
            <div class="about-block">
              <a href="#/getInTouch">{{ $t('footer.getInTouch') }}</a>
          ...
          <div class="our-contact">
            ...
            <div class="contact-block">
              <div class="contact-box">
                ...
                <a href="">hexaversepro@gmail.com</a>
              </div>
              <div class="contact-box">
                <i class="fas fa-phone-alt"></i>
                <a href="">+48 93939 0239</a>
              </div>
              <div class="contact-box">
                <i class="fas fa-phone-alt"></i>
                <a href="">+84 83939 0237</a>
              </div>
              <div class="contact-box">
                <i class="fas fa-calendar-alt"></i>
                <a href="">{{ $t('footer.monFri') }}</a>
              </div>
              <div class="contact-box">
...
/* Footer theme colors are defined globally in App.vue so the
   .light/.dark selectors are emitted verbatim (scoped :global() was
   collapsing them into a bare .light rule). */
...
.footer-subscribe input {
  ...
  outline: none;
  border-radius: 8px;
  background-color: rgba(0, 2, 122, 0);
  border: 1px solid rgba(255, 251, 251, 0.911);
  padding: 0px 27px;
  height: 36px;
  margin-top: 23px;
  color: aliceblue;
